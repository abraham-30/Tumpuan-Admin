...
class ManageRoleTable extends StatelessWidget{
  const ManageRoleTable({Key? key, required this.tableName, required this.deleteButtonLabel, required this.updateButtonLabel}) : super(key: key);
