...
class KategoriSuaraPuanTable extends StatelessWidget{
  const KategoriSuaraPuanTable({Key? key, required this.tableName, required this.deleteButtonLabel, required this.updateButtonLabel}) : super(key: key);
