...
class DailyQuizTable extends StatelessWidget{
  const DailyQuizTable({Key? key, required this.tableName, required this.deleteButtonLabel, required this.updateButtonLabel}) : super(key: key);
