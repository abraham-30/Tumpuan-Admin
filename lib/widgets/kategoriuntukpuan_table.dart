...
class KategoriUntukPuanTable extends StatelessWidget{
  const KategoriUntukPuanTable({Key? key, required this.tableName, required this.deleteButtonLabel, required this.updateButtonLabel}) : super(key: key);
